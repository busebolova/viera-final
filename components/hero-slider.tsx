...
export function HeroSlider({ content }: HeroSliderProps) {
  ...
  const heroTitle = content?.title || "Viera & Alkan Yapı"
  const heroDescription =
    content?.description ||
    "60 yılı aşkın deneyimimiz ve köklü geçmişimizle konut ve iş yeri üretiminde güven ve kaliteyi ön planda tutuyoruz."
  const videoUrl = content?.url || "https://cdn.pixabay.com/video/2020/06/23/42926-434300944_large.mp4"
  ...
  const useImageBackground = heroImage && !content?.url
